...
if __name__ == '__main__' :
        ...
        authInfo['user'] = 'hcpyou@163.com'
        authInfo['password'] = 'zxmhcp163'
        fromAdd = 'hcpyou@163.com'
        toAdd = "1035472146@qq.com"
        ccAdd = "hcpyou@163.com"
        subject = 'title'
        plainText = '这里是普通文本\n'
        htmlText = '<B>HTML文本</B>'
        htmlPath=r"F:\workspace\untitled\\report\2016-02-21-19_56_44_result.html"
        attachment=r"F:\workspace\untitled\\report\2016-02-21-19_56_44_result.html"
        sendEmail(authInfo, fromAdd, toAdd, ccAdd, subject, plainText, htmlPath, attachment)
